...
//        public FormPersonaController(IHttpClientFactory http)
//        {
//            _http = http;
//        }
...
//        //[HttpGet]
//        //public async Task<IActionResult> FormularioAdopcion()
//        //{
...
//        //    // Filtrar solo preguntas del formulario de adopción (supongamos tipoFormulario = 1)
//        //    preguntas = preguntas
//        //        .Where(p => p.id_tipoFormulario == 1)
//        //        .OrderBy(p => p.orden)
//        //        .ToList();
...
//        // ===================== GET: formulario adopción =====================
//        [HttpGet]
//        public async Task<IActionResult> FormularioAdopcion(int? idPersona)
//        {
//            if (idPersona == null)
//            {
//                ViewBag.ApiError = "No se recibió la persona a asociar.";
//                return RedirectToAction("PersonaAdoptar");
//            }
...
//        [HttpPost]
//        public async Task<IActionResult> FormularioAdopcion(int idPersona, Dictionary<int, string> respuestas)
//        {
//            var client = _http.CreateClient("Api");

//            int idFormulario = 1;  //ID del formulario de adopción, ajustar según tu base de datos

//            // Preparar payload compatible con api/Respuesta/lote/{idFormulario}
//            var payload = new
//            {
//                respuestas = respuestas.Select(r => new { id_pregunta = r.Key, respuesta = r.Value })
//            };

//            var result = await client.PostAsJsonAsync($"/api/Respuesta/lote/{idFormulario}", payload);

//            if (result.IsSuccessStatusCode)
//            {
//                ViewBag.Mensaje = "Respuestas enviadas correctamente.";
//            }
//            else
//            {
//                var body = await result.Content.ReadAsStringAsync();
//                ViewBag.Mensaje = $"Error al enviar respuestas: {(int)result.StatusCode} {body}";
//            }

//            return RedirectToAction("IndexPublic", "HomePublic"); // Vista de confirmación
...
//        [HttpGet]
//        public async Task<IActionResult> PersonaAdoptar()
//        {
//            var client = _http.CreateClient("Api");
...
//            return View("~/Views/Formularios/FormPerAdopcion.cshtml", new Persona { fechaIngreso = DateTime.Today });
//        }

//        [HttpPost, ValidateAntiForgeryToken]
//        public async Task<IActionResult> PersonaAdoptar([FromForm] Persona persona)
//        {
//            // Sanitizar y validar
...
//            // Si el usuario no elige estado, se asigna uno por defecto
...
//                return View("~/Views/Formularios/FormPerAdopcion.cshtml", persona);
//            }

//            // Enviar persona al API
//            var client = _http.CreateClient("Api");
...
//            // ====== Recuperar ID de la persona recién creada ======
//            var respuestaBody = await resp.Content.ReadAsStringAsync();
//            var personaCreada = JsonSerializer.Deserialize<Persona>(respuestaBody, new JsonSerializerOptions { PropertyNameCaseInsensitive = true });
...
//        //    TempData["Ok"] = "Persona creada correctamente.";
//        //    return RedirectToAction("FormularioAdopcion", "FormPersona");
//        //}
